...
namespace StandardApi.Framework.Configuration.Options
{
    public class JwtOptions
    {
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 3 moths ~ 90day)
        /// </summary>
        public TimeSpan ValidFor { get; set; } = TimeSpan.FromDays(90);
